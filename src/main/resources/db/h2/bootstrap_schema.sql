...
CREATE TABLE COMMENT (
    ...
    SOURCE_TYPE VARCHAR(50) NOT NULL,   -- TYPE OF SOURCE TYPE BEING COMMENTED ON
    ...
    EDITED BOOLEAN DEFAULT FALSE,       -- TRUE IF COMMENT WAS EDITED
    UPVOTE_COUNT INT NOT NULL DEFAULT 0
);
-- MODELS A VOTE ON A SOURCE
CREATE TABLE VOTE (
    ID INT DEFAULT VOTE_SEQUENCE.NEXTVAL PRIMARY KEY,
    SOURCE_TYPE VARCHAR(50) NOT NULL,   -- TYPE OF SOURCE TYPE BEING VOTED ON
    ...
    CONSTRAINT U_VOTE_AUTHOR_ID_SOURCE_TYPE_ITEM_ID UNIQUE (AUTHOR_ID, SOURCE_TYPE, ITEM_ID)
);